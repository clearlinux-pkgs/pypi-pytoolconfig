...
Source0  : https://files.pythonhosted.org/packages/6e/c1/6156c684e2879c4873ef470048710ec00b08e639c9142c9263cf443f6f2b/pytoolconfig-1.2.1.tar.gz
...
%prep
%setup -q -n pytoolconfig-1.2.1
cd %{_builddir}/pytoolconfig-1.2.1
pushd ..
cp -a pytoolconfig-1.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657036792
...
cp %{_builddir}/pytoolconfig-1.2.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pytoolconfig/a8a12e6867d7ee39c21d9b11a984066099b6fb6b
