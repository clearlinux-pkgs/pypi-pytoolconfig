...
Source0  : https://github.com/bagel897/pytoolconfig/archive/refs/tags/v1.2.3.tar.gz
...
%prep
%setup -q -n pytoolconfig-1.2.3
cd %{_builddir}/pytoolconfig-1.2.3
pushd ..
cp -a pytoolconfig-1.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666803906
